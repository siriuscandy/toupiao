...
u.extend(u, {
	...
	hasClass: function(element, value){
		if (element.nodeName === '#text'||element.nodeName === '#comment') return false;
		if (typeof element.classList === 'undefined') {
...
u.date= {
    ...
    format: function(date, formatString, language){
        ...
        //火狐下不支持new Date方法含有时分秒的参数
        if(u.isFF&& typeof date==='string' ){
            date=date.replace(' ','T');
        }
    ...
    getDateObj: function(value){
        ...
        if (isNaN(_date)){
            ...
            if(index1 > 0 || index2 > 0 || index3 > 0){
                ...
                if(s2 && s2.length > 0){
                    _date.setHours(s2[0]);
                    _date.setMinutes(s2[1]);
                    _date.setSeconds(s2[2]);
                    dateFlag = true;
                }
            }else{
...
u.dateTimePickerTemplateArr = ['<div class="u-date-panel">',
                            ...
                            '<div class="u-date-nav">',
                                '<button class="u-button u-date-ok right">确定</button>',
...
//u.DatePicker = u.DateTimePicker;
//
//
//if (u.compMgr)
//	u.compMgr.regComp({
//		comp: u.DatePicker,
//		compAsString: 'u.DatePicker',
//		css: 'u-datepicker'
//	})
...
u.ClockPicker = u.BaseComponent.extend({
		...
		init:function(){
			...
			this.template = '<div class="u-combo-ul popover clockpicker-popover" style="padding:0px;">';
			this.template += '<div class="popover-title"><span class="clockpicker-span-hours">02</span> : <span class="clockpicker-span-minutes text-primary">01</span><span class="clockpicker-span-am-pm"></span></div>';
			...
			this.template += '			<svg class="clockpicker-svg" width="200" height="200">';
			...
			this.template += '			<div class="clockpicker-tick" style="left: 87px; top: 7px;">00</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 114px; top: 40.2346px; font-size: 120%;">1</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 133.765px; top: 60px; font-size: 120%;">2</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 141px; top: 87px; font-size: 120%;">3</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 133.765px; top: 114px; font-size: 120%;">4</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 114px; top: 133.765px; font-size: 120%;">5</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 87px; top: 141px; font-size: 120%;">6</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 60px; top: 133.765px; font-size: 120%;">7</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 40.2346px; top: 114px; font-size: 120%;">8</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 33px; top: 87px; font-size: 120%;">9</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 40.2346px; top: 60px; font-size: 120%;">10</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 60px; top: 40.2346px; font-size: 120%;">11</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 87px; top: 33px; font-size: 120%;">12</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 127px; top: 17.718px;">13</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 156.282px; top: 47px;">14</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 167px; top: 87px;">15</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 156.282px; top: 127px;">16</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 127px; top: 156.282px;">17</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 87px; top: 167px;">18</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 47px; top: 156.282px;">19</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 17.718px; top: 127px;">20</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 7px; top: 87px;">21</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 17.718px; top: 47px;">22</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 47px; top: 17.718px;">23</div>';
			this.template += '		</div>';
			this.template += '		<div class="clockpicker-dial clockpicker-minutes" style="visibility: hidden;">';
			this.template += '			<div class="clockpicker-tick" style="left: 87px; top: 7px; font-size: 120%;">00</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 127px; top: 17.718px; font-size: 120%;">05</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 156.282px; top: 47px; font-size: 120%;">10</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 167px; top: 87px; font-size: 120%;">15</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 156.282px; top: 127px; font-size: 120%;">20</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 127px; top: 156.282px; font-size: 120%;">25</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 87px; top: 167px; font-size: 120%;">30</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 47px; top: 156.282px; font-size: 120%;">35</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 17.718px; top: 127px; font-size: 120%;">40</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 7px; top: 87px; font-size: 120%;">45</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 17.718px; top: 47px; font-size: 120%;">50</div>';
			this.template += '			<div class="clockpicker-tick" style="left: 47px; top: 17.718px; font-size: 120%;">55</div>';
			this.template += '		</div>';
...
if (u.compMgr)
	...
	u.pagination.prototype.render = function() {
		...
		if (options.totalCount > 0) {
			var htmlStr = '<li class="all_page"><a style="cursor:default;background-color:#FFF;">' + options.totalText + options.totalCount + '</a></li>';
		...
		if (options.jumppage || options.pageSize) {
			...
			var tmpjump = "<li class='tonextpage'><a>" + (options.jumppage ? jumppagehtml : "") + (options.pageSize ? sizehtml : "") + "<i class='jump_page fa fa-arrow-circle-right' style='margin-left: 8px; cursor: pointer;'></i></a></li>";
...
DataTable.fn.getMeta = function (fieldName, key) {
    ...
    if(this.meta[fieldName] && this.meta[fieldName][key]){
    ...
    return ko.pureComputed({
        read: function () {
            ...
            if (row) {
                ...
                //    var _field = row._findField(fieldName);
                //    if (_field)
                //        return _field['value'];
                //    else{ // 有子表存在
...
// * @param {Object} fieldName
// */
//DataTable.fn.refChildRows = function (fieldName) {
//    return ko.pureComputed({
//        read: function () {
//            //this.valueChange()
//            this.currentRowChange();
//            var row = this.getCurrentRow()
//            if (row){
//                var childDt =  row.getValue(fieldName);
...
Row.fn.ref = function (fieldName) {
    ...
    return ko.pureComputed({
        read: function () {
            ...
            //if (value instanceof u.DataTable)
            //    return value.rows();
            //else
            return value;
        },
    ...
    for (var key in sourceData) {
        ...
        if (valueObj == null ||  typeof valueObj != 'object')
            ...
            if (valueObj.error) {
                ...
                //ns 是多级数据时的空间名： 最顶层的dataTable没有ns。  f1.f2.f3
                var ns = this.parent.ns === '' ? key : this.parent.ns + '.' + key
                targetData[key].value = new u.DataTable({root:this.parent.root,ns:ns});
...
Row.fn.setData = function (data) {
    ...
    this._setData(sourceData, targetData);
...
Row.fn._getSimpleData = function(data){
    ...
    for(var key in data){
        if (key === 'meta' || u.isEmptyObject(data[key])){
            ...
            _data[key] = data[key].value.getSimpleData();
...
u.TextFieldAdapter = u.BaseAdapter.extend({
    ...
    initialize: function (options) {
        ...
        //this.validate = this.trueAdpt.validate;
        //this.doValidate = this.trueAdpt.doValidate;
...
u.DateTimeAdapter = u.BaseAdapter.extend({
	initialize: function (options) {
		...
		if (options.options.type === 'u-date')
		...
		this.comp.on('select', function(event){
			self.slice = true;
			 if(self.dataModel){
            	 self.dataModel.setValue(self.field, event.value);
            	 this.element.ucomp.change(this._input.value)
            }
			self.slice = false;
			//self.setValue(event.value);
		});
